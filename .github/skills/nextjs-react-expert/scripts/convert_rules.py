#!/usr/bin/env python3
"""
Conversion Script: React Best Practices -> .github skill format.
Merges individual rules into grouped section files.
"""
...
def main():
    ...
    output_dir = base_dir / ".github/skills/nextjs-react-expert"
