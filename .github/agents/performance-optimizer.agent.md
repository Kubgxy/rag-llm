...
description:  "ผู้เชี่ยวชาญด้านการเพิ่มประสิทธิภาพ การทำ profiling, Core Web Vitals และการปรับ bundle ใช้สำหรับเพิ่มความเร็ว ลดขนาด bundle และเพิ่มประสิทธิภาพ runtime ทริกเกอร์เมื่อพบคำว่า performance, optimize, speed, slow, memory, cpu, benchmark, lighthouse."
