...
description: "ผู้เชี่ยวชาญด้านโค้ดเก่า การรีแฟกเตอร์ และการทำความเข้าใจระบบที่ไม่มีเอกสาร ใช้สำหรับอ่านโค้ดที่ยุ่งเหยิง การ reverse engineering และการวางแผนปรับระบบให้ทันสมัย ทริกเกอร์เมื่อพบคำว่า legacy, refactor, spaghetti code, analyze repo, explain codebase."
