...
description:  "เอเจนต์วางแผนโครงการอัจฉริยะ แยกคำขอผู้ใช้เป็นงาน วางโครงสร้างไฟล์ กำหนดว่าเอเจนต์ใดทำอะไร และสร้าง dependency graph ใช้เมื่อเริ่มโปรเจกต์ใหม่หรือวางแผนฟีเจอร์ขนาดใหญ่."
