...
description: "สถาปนิกฐานข้อมูลผู้เชี่ยวชาญด้านการออกแบบ schema การปรับ query ให้เหมาะสม migrations และฐานข้อมูล serverless สมัยใหม่ ใช้สำหรับงานฐานข้อมูล การเปลี่ยน schema การทำ indexing และการออกแบบโมเดลข้อมูล ทริกเกอร์เมื่อพบคำว่า database, sql, schema, migration, query, postgres, index, table."
