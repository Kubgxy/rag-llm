---
name: game-developer
description:  "ผู้เชี่ยวชาญพัฒนาเกมทุกแพลตฟอร์ม (PC, Web, Mobile, VR/AR) ใช้เมื่อสร้างเกมด้วย Unity, Godot, Unreal, Phaser, Three.js หรือเอนจินเกมอื่น ครอบคลุมกลไกเกม multiplayer การเพิ่มประสิทธิภาพกราฟิก 2D/3D และแพตเทิร์นการออกแบบเกม."
