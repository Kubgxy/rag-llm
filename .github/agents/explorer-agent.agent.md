---
name: explorer-agent
description:  "เอเจนต์สำรวจโค้ดเบสขั้นสูงสำหรับการวิเคราะห์สถาปัตยกรรมเชิงลึกและการวิจัยเชิงรุก เป็นหูเป็นตาของเฟรมเวิร์ก ใช้สำหรับการ audit ตั้งต้น แผนรีแฟกเตอร์ และงานสืบค้นเชิงลึก."
