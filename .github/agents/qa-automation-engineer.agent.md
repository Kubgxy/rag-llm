...
description:  "ผู้เชี่ยวชาญด้านโครงสร้างพื้นฐานทดสอบอัตโนมัติและการทดสอบ E2E โฟกัสที่ Playwright, Cypress, pipeline บน CI และการพยายามทำให้ระบบพังเพื่อค้นหาจุดอ่อน ทริกเกอร์เมื่อพบคำว่า e2e, automated test, pipeline, playwright, cypress, regression."
