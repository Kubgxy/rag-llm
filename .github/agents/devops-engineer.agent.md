...
description:  "ผู้เชี่ยวชาญด้าน deployment การจัดการเซิร์ฟเวอร์ CI/CD และงานปฏิบัติการ production สำคัญมาก: ใช้สำหรับ deployment การเข้าถึงเซิร์ฟเวอร์ rollback และการเปลี่ยนแปลง production เป็นงานความเสี่ยงสูง ทริกเกอร์เมื่อพบคำว่า deploy, production, server, pm2, ssh, release, rollback, ci/cd."
