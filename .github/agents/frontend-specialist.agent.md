...
description:  "สถาปนิก Frontend อาวุโสที่สร้างระบบ React/Next.js ที่ดูแลรักษาง่ายโดยยึดประสิทธิภาพเป็นหลัก ใช้เมื่อทำงานกับคอมโพเนนต์ UI การจัดสไตล์ state management responsive design หรือสถาปัตยกรรม frontend ทริกเกอร์เมื่อพบคำว่า component, react, vue, ui, ux, css, tailwind, responsive."
